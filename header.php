...
<header class="header">
        ...
        <div class="container header__inner">
            ...
            <div class="icons"> 
                <ul>
                  <li><a href="login.php" id="icon1" class="logging"><i class="fa-regular fa-user"></i></a>
                      <div id="usernameMenu"><span id="usernameDisplay"><?php echo $_SESSION['username']; ?></span></div>
                  </li>
                  <li>
